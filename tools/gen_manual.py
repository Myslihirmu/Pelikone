...
games = [
    ...
    ("RISTINOLLA", "Kolme suoraan voittaa. Valitse alussa <b>2 PELAAJAA</b> (yksi laite) tai <b>2 LAITETTA</b> (langaton).",
    ...
    ("SHAKKI", "Tavallinen shakki. Valitse alussa <b>HELPPO</b>/<b>VAIKEA</b> (konetta vastaan), <b>2 PELAAJAA</b> (yksi laite) tai <b>2 LAITETTA</b> (langaton).",
